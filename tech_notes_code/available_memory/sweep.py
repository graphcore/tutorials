...
def run_demo(batch_size, available_memory_proportion):
    cmd = ["python", "pytorch_demo.py", "--available-memory-proportion", str(available_memory_proportion), "--batch-size", str(batch_size)]
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch-size-max', type=int, default=26, help="Batch size maximum (non-inclusive)")
    parser.add_argument('--batch-size-step', type=int, default=2, help="Batch size step size")
    parser.add_argument('--available-memory-min', type=float, default=0.1, help="Available memory proportion minimum (inclusive)")
    parser.add_argument('--available-memory-max', type=float, default=1.0, help="Available memory proportion maximum (non-inclusive)")
    parser.add_argument('--available-memory-step', type=float, default=0.1, help="Available memory proportion step size")
