...
Training
Epoch 1/3
938/938 [==============================] - 9s 9ms/step - loss: 0.9664 - accuracy: 0.6956
Epoch 2/3
938/938 [==============================] - 8s 9ms/step - loss: 0.3094 - accuracy: 0.9064
Epoch 3/3
938/938 [==============================] - 8s 9ms/step - loss: 0.2291 - accuracy: 0.9319

Evaluation
157/157 [==============================] - 1s 4ms/step - loss: 0.1390 - accuracy: 0.9608
```

```output
[0.13901665806770325, 0.9607999920845032]
```
...
Epoch 1/3
937/937 [==============================] - 47s 3ms/step - loss: 0.9333 - accuracy: 0.7083
INFO:tensorflow:The model `model_1` has been configured with only 1 steps per execution. Consider increasing the value for the `steps_per_execution` argument passed to the `compile()` method to improve performance.
Epoch 2/3
937/937 [==============================] - 2s 2ms/step - loss: 0.3035 - accuracy: 0.9088
INFO:tensorflow:The model `model_1` has been configured with only 1 steps per execution. Consider increasing the value for the `steps_per_execution` argument passed to the `compile()` method to improve performance.
Epoch 3/3
937/937 [==============================] - 2s 2ms/step - loss: 0.2189 - accuracy: 0.9345
...
INFO:tensorflow:The provided set of data has an unknown size. This can result in runtime errors if not enough data is provided during execution.
INFO:tensorflow:The model `model_1` has been configured with only 1 steps per execution. Consider increasing the value for the `steps_per_execution` argument passed to the `compile()` method to improve performance.
156/156 [==============================] - 20s 2ms/step - loss: 0.1321 - accuracy: 0.9622
```
...
INFO:tensorflow:The provided set of data has an unknown size. This can result in runtime errors if not enough data is provided during execution.
Epoch 1/3
937/937 [==============================] - 47s 50ms/step - loss: 0.9916 - accuracy: 0.6873
Epoch 2/3
937/937 [==============================] - 0s 236us/step - loss: 0.3142 - accuracy: 0.9056
Epoch 3/3
937/937 [==============================] - 0s 242us/step - loss: 0.2269 - accuracy: 0.9311

Evaluation
INFO:tensorflow:The provided set of data has an unknown size. This can result in runtime errors if not enough data is provided during execution.
156/156 [==============================] - 20s 126ms/step - loss: 0.1373 - accuracy: 0.9621
```
...
Epoch 1/3
468/468 [==============================] - 47s 100ms/step - loss: 0.9749 - accuracy: 0.6914
Epoch 2/3
468/468 [==============================] - 0s 265us/step - loss: 0.3049 - accuracy: 0.9092
Epoch 3/3
468/468 [==============================] - 0s 268us/step - loss: 0.2258 - accuracy: 0.9317

Evaluation
INFO:tensorflow:The provided set of data has an unknown size. This can result in runtime errors if not enough data is provided during execution.
78/78 [==============================] - 20s 261ms/step - loss: 0.1386 - accuracy: 0.9611
```
...
Epoch 1/3
936/936 [==============================] - 56s 60ms/step - loss: 1.0196 - accuracy: 0.6729
Epoch 2/3
936/936 [==============================] - 0s 286us/step - loss: 0.3153 - accuracy: 0.9040
Epoch 3/3
936/936 [==============================] - 0s 282us/step - loss: 0.2224 - accuracy: 0.9335

Evaluation
INFO:tensorflow:The provided set of data has an unknown size. This can result in runtime errors if not enough data is provided during execution.
WARNING:tensorflow:offload_weight_update_variables will have no effect since this pipeline is in inference.
WARNING:tensorflow:offload_weight_update_variables will have no effect since this pipeline is in inference.
152/152 [==============================] - 26s 169ms/step - loss: 0.1493 - accuracy: 0.9375
```
...
Generated:2022-05-19T17:24 Source:demo.py SDK:2.5.1+1001 SST:0.0.7
