...
def get_mnist_data(opts):
    ...
    training_data = poptorch.DataLoader(
        options,
        torchvision.datasets.MNIST('~/.torch/datasets',
                                   train=True,
                                   download=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device-iterations',
                        type=int,
                        default=10,
    ...
    parser.add_argument(
        ...
        default="./profile",
        help=
        "where to save the profile (default: ./profile)"
    )
    parser.add_argument('--strategy',
                        choices=['sharded', 'pipelined'],
                        default='pipelined',
                        help='execution strategy')
    parser.add_argument('--offload-optimiser',
                        action='store_true',
                        help="offload optimiser state")
    parser.add_argument('--debug',
                        action='store_true',
                        help="print out the debug logging while running")
    ...
    if opts.profile:
        ...
        profile_opts = {"autoReport.all": "true",
