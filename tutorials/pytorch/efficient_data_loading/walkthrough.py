...
- The PopTorch Python library installed (see
  [Installation](https://docs.graphcore.ai/projects/poptorch-user-guide/en/3.1.0/installation.html)
...
See the
[documentation](https://docs.graphcore.ai/projects/poptorch-user-guide/en/3.1.0/batching.html#poptorch-asynchronousdataaccessor)
...
[documentation](https://docs.graphcore.ai/projects/poptorch-user-guide/en/3.1.0/reference.html?highlight=anchormode#poptorch.Options.outputMode)
...
guide](https://docs.graphcore.ai/projects/memory-performance-optimisation/en/3.1.0/optimising-performance.html#host-ipu-io-optimisation).
"""
