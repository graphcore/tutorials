...
- the [`libpvti`
  module](https://docs.graphcore.ai/projects/libpvti/en/3.1.0/index.html) in
...
[PVTI library documentation](https://docs.graphcore.ai/projects/libpvti/en/3.1.0/index.html).
