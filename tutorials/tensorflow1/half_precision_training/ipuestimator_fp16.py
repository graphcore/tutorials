...
ipu_run_configuration = ipu.ipu_run_config.IPURunConfig(
    iterations_per_loop=batches_per_epoch,
    ipu_options=ipu_configuration
)

run_configuration = ipu.ipu_run_config.RunConfig(
    log_step_count_steps=batches_per_epoch,
    ipu_run_config=ipu_run_configuration
)

ipu_estimator = ipu.ipu_estimator.IPUEstimator(
    config=run_configuration,
    model_fn=make_estimator_spec
)
...
ipu_estimator.train(input_fn=make_dataset_from_generator, steps=args.epochs*batches_per_epoch)
