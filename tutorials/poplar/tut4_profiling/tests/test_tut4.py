...
def test_run_ipu_hardware():
    ...
    testing_util.run_command(
        "./tut4_ipu_hardware", working_path, ["Program complete", "Memory Usage:"]
    )
...
def test_run_ipu_model():
    ...
    testing_util.run_command(
        "./tut4_ipu_model", working_path, ["Program complete", "Memory Usage:"]
    )
...
def test_run_cpp_example():
    ...
    with tempfile.TemporaryDirectory() as temporary_path:
        ...
        # Inspect reports
        testing_util.run_command(
            "./cpp_example", temporary_path, ["Example information from profile"]
        )
