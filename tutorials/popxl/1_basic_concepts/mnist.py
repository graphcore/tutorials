...
concepts](https://docs.graphcore.ai/projects/popxl/en/3.0.0/concepts.html#concepts)
will be helpful, but not essential:

- Intermediate representation
  ([IR](https://docs.graphcore.ai/projects/popxl/en/3.0.0/concepts.html#irs))
- Tensors (variable, constant and intermediate)
- [Graphs](https://docs.graphcore.ai/projects/popxl/en/3.0.0/concepts.html#graphs)
  (main and subgraph)
...
optimisation
guide](https://docs.graphcore.ai/projects/memory-performance-optimisation/en/3.0.0/common-memory-optimisations.html#graph-outlining).

These concepts becomes important when we start building more complicated models
using the
[`Module`](https://docs.graphcore.ai/projects/popxl/en/3.0.0/api.html#modules)
...
[streams](https://docs.graphcore.ai/projects/popxl/en/3.0.0/op.html#data-input-and-output)
...
[popxl.autodiff](https://docs.graphcore.ai/projects/popxl/en/3.0.0/transforms.html#autodiff)
...
[calling-a-subgraph](https://docs.graphcore.ai/projects/popxl/en/3.0.0/graph.html#calling-a-subgraph))
