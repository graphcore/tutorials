...
def rnn(opts, inputs):
    ...
    return tf.nn.dynamic_rnn(
        cell=rnn_cell, inputs=inputs, dtype=inputs.dtype, time_major=True
    )
...
if __name__ == "__main__":
    ...
    print(
        "RNN layer {'Training' if options.train else 'Inference'} Synthetic benchmark.\n"
        " Batch size {options.batch_size}.\n"
        " Batches per Step {options.batches_per_step}.\n"
        " Steps {options.steps}.\n"
        " Hidden size {options.hidden_size}.\n"
