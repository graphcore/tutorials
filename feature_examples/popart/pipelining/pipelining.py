...
def create_pipelined_model(num_features, num_classes, batch_size):
    ...
    with builder.virtualGraph(0):
        x1 = builder.aiOnnx.gemm([x0, W0, b0], debugContext="gemm_x1")
        x2 = builder.aiOnnx.relu([x1], debugContext="relu_x2")
    ...
    with builder.virtualGraph(1):
        x3 = builder.aiOnnx.gemm([x2, W1, b1], debugContext="gemm_x3")
        x4 = builder.aiOnnx.relu([x3], debugContext="relu_x4")
